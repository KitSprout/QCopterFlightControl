...
/**
  * @brief  Quaternion_MultVector
  */
__INLINE void Quaternion_MultVector( quaternion_t *pNumQ, const quaternion_t *pNumA, const float32_t *pVect )
{
  if (pNumQ == pNumA) {
    quaternion_t tmpQ;
    tmpQ.q0 = pNumA->q0;
...
/**
  * @brief  Quaternion_Conj
  */
__INLINE void Quaternion_Conj( quaternion_t *pNumQ, const quaternion_t *pNumC )
{
  pNumQ->q0 =  pNumC->q0;
  pNumQ->q1 = -pNumC->q1;
  pNumQ->q2 = -pNumC->q2;
...
/**
  * @brief  Quaternion_Norm
  */
__INLINE void Quaternion_Norm( quaternion_t *pNumQ, const quaternion_t *pNumN )
{
...
/**
  * @brief  Quaternion_FastNorm
  */
__INLINE void Quaternion_FastNorm( quaternion_t *pNumQ, const quaternion_t *pNumN )
{
