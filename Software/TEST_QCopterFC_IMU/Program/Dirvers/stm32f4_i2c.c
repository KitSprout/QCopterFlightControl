...
/*=====================================================================================================*/
/*=====================================================================================================*/
static vu8 *I2C_ReadPtr;
static vu8 *I2C_WritePtr;
static vu32 I2C_TimeCnt = I2C_TIMEOUT;
/*=====================================================================================================*/
/*=====================================================================================================*
**函數 : I2C_Config
**功能 : I2C 設定 & 配置
...
**輸出 : Status
**使用 : I2C_ReadByte(SlaveAddr, ReadBuf, NumByte);
**=====================================================================================================*/
/*=====================================================================================================*/
u32 I2C_ReadByte( u8 SlaveAddr, u8 *ReadBuf, u8 NumByte )
{
  DMA_InitTypeDef DMA_InitStruct;
...
**=====================================================================================================*/
/*=====================================================================================================*/
u32 I2C_WriteByte( u8 SlaveAddr, u8 *WriteBuf, u8 NumByte )
{
  DMA_InitTypeDef DMA_InitStruct;
...
**函數 : I2C_DMA_ReadReg
**功能 : I2C DMA Read Reg
**輸入 : SlaveAddr, ReadAddr, *ReadBuf, NumByte
**輸出 : Status
