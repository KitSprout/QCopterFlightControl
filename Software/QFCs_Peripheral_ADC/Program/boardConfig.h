...
#define BAT_MAX_CHANNEL               1
#define BAT_MAX_SAMPLEBUF             8

#define BAT_ADCx                      ADC1
#define BAT_ADCx_CLK_ENABLE()         __HAL_RCC_ADC1_CLK_ENABLE()
#define BAT_ADCx_DMA_CLK_ENABLE()     __HAL_RCC_DMA2_CLK_ENABLE()
...
#define BAT_ADCx_DMA_IRQn_PREEMPT     0x0F
#define BAT_ADCx_DMA_IRQn_SUB         0x0F

#define BAT_ADCx_FORCE_RESET()        __HAL_RCC_ADC_FORCE_RESET()
#define BAT_ADCx_RELEASE_RESET()      __HAL_RCC_ADC_RELEASE_RESET()
#define BAT_ADCx_SAMPLETIME           ADC_SAMPLETIME_480CYCLES
