...
void ADC_Config( void )
{
  ...
  /* ADC1 Regular Config ******************************************************/
  ADC_RegularChannelConfig(ADC1, ADC_Channel_14, 1, ADC_SampleTime_28Cycles); // ADC_I

  /* ADC2 Regular Config ******************************************************/
  ADC_RegularChannelConfig(ADC2, ADC_Channel_15, 1, ADC_SampleTime_28Cycles); // ADC_V
